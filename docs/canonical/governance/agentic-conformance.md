...
sources:
  ...
  - resource: ../../020-autonomous-implementation-program-design-verification-v1-delivery/020-K-full-autonomous-implementation-roadmap-agent-assignment-phase-package-definitions-entry-readiness.md
