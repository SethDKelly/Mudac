...
title: Coverage
description: Sufficiency of qualifying judging evidence, independent from numerical Aggregate.
status: stable
tags: [mechanism, evaluation, eligibility]
sources:
...
Coverage answers whether enough qualifying judging has occurred under [Evaluation Policy](../policies/evaluation-policy.md).
