...
This subtree is the preferred source for current MUDAC conceptual product meaning and governance. Architecture and implementation material remain **suspended downstream candidates** while Jackson Concept Design is reopened.
...
* [Synchronizations](synchronizations/) — preserved pre-011 composition evidence plus routing to the current Phase 011 classification/revalidation authority.
...
[011-A](../011-concept-composition-synchronization/011-A-composition-scope-evidence-reuse-synchronization-risk-subphase-planning.md) establishes the Phase 011 scope and dependency-safe sequence.

[011-B](../011-concept-composition-synchronization/011-B-legacy-synchronization-inventory-composition-obligation-map-application-action-baseline.md) is the current inventory/classification authority for the sixteen pre-011 synchronization contracts, CO-01 through CO-12 ownership, post-Phase-010 composition gaps, and the provisional application-action baseline.
...
The legacy synchronization bodies remain preserved evidence, not current contract authority. 011-C through 011-H will establish current family semantics; 011-I will close action-surface/chaining/automation/coherence questions; 011-J will reconcile canonical synchronization ownership.
...
For Phase 011 specifically, use 011-B for current legacy-contract disposition and action-baseline meaning. Use the old [Synchronizations](synchronizations/) and Phase 007-C/007-D only as reusable evidence unless a later 011 subgroup has established replacement/current semantics.
...
The immediate next work is **011-C — Competition Lifecycle, Identity, Participation, Access & Operating-Context Composition**.