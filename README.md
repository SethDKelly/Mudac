...
- [docs/index.md](docs/index.md) — preferred authored repository-native progressive-disclosure entry point.
...
- [Phase 020](docs/020-autonomous-implementation-program-design-verification-v1-delivery/) — **ACTIVE — 020-A/B/C/D/E COMPLETE / 020-F NEXT ELIGIBLE**.
...
Phase 018 and Phase 019 are complete. **Phase 020 is ACTIVE** as the final pre-implementation design lifecycle; 020-A/B/C/D/E are complete and 020-F is next eligible. Whole architecture remains accepted and G0 permits program/package derivation, while domain implementation execution remains unauthorized until a later explicit G2 decision.
