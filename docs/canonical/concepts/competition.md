...
Competition owns its stable identity, descriptive/event context, and lifecycle:
...
A post-Finalization correction may lead to a successor [Official Outcome Revision](../mechanisms/official-outcome-revision.md) while Competition remains Finalized.
