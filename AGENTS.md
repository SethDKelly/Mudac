...
- Phase 005 architecture: preserved historical/downstream candidate.
- Phase 006 implementation planning: historical; 006-D frozen.
- 007-I methodology exit: historical/superseded as current closure authority.
- 008-A–C: preserved premature implementation-reentry/planning provenance.
- 008-D persistence plan: suspended downstream hypothesis.
- 008-E identity/auth plan: suspended downstream hypothesis.
- 008-F–L: not active.

A future successful Phase 017 may authorize only a separate architecture/engineering re-entry. It does not automatically reactivate any of the above.

## Knowledge validation

Knowledge-only changes should run the repository knowledge validation path. Passing CI validates the tested revision; it does not prove methodology completion or authorize downstream work.
