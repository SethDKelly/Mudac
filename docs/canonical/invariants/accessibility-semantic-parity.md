...
title: Accessibility Is Semantic Parity
description: Accessibility adaptations change representation or interaction mechanics without weakening domain meaning, authority, privacy, or evidence semantics.
status: stable
tags: [invariant, accessibility, ux]
sources:
...
No core operation may require mouse, hover, camera/QR, color, one orientation, or fine-pointer precision as its only path.
