...
- [Synchronizations](../canonical/synchronizations/), especially the application action surface;
...
capabilities never union across Judge/Organizer Participations
...
Phase 013 defines semantic mapping obligations, not frontend/runtime implementation.
