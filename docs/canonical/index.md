...
004-C established baseline canonical product/UX owners; 004-D established bidirectional historical lineage; 004-E added stable rule IDs/reference-first reuse; 004-F established documentation authority, agent-context, and canonical-change governance.
...
* [Governance](governance/) - Methodology/terminology, documentation authority (`DOC-*`), agent context (`CTX-*`), canonical change governance (`CHG-*`), source lineage, and stable rule IDs.
