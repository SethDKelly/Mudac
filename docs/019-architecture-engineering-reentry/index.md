...
- 019-B — Architecture Drivers, Quality Attributes, Workload, Trust Boundary & Constraint Qualification — **NEXT ELIGIBLE**
- 019-C — Application Ownership, Boundary, Coordination & Dependency Architecture — PLANNED
