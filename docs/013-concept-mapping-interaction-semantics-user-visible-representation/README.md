...
mapping authority
  = how that meaning becomes perceivable / invocable / understandable

frontend / runtime realization
  = out of scope
```
...
Phase 013 maps the Phase-011 application action surface (`D / C / P / S / X`), not an arbitrary union of Concept actions.
