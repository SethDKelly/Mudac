...
[AGT-007](agentic-authority-scope.md#agt-007) classifies a semantic or accepted-architecture change as A4. A human may explicitly request such a change, but the change must still follow this canonical workflow, stable-ID compatibility review, lineage preservation and dependent-impact review.

The A4 label is a scope/authorization classification. It does not replace the substantive change analysis owned here.
