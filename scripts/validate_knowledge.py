...
class Validator:
    ...
    def validate_routing_contract(self) -> None:
        required = [
            ...
            self.root / "scripts" / "validate_architecture_reentry_plan.py",
            self.root / "scripts" / "validate_implementation_program_framework.py",
            self.root / "scripts" / "validate_phase019_architecture_control.py",
            self.root / "scripts" / "validate_phase020_implementation_design_control.py",
            self.docs / "routing" / "downstream_candidate_qualification.json",
            self.docs / "routing" / "architecture_reentry_plan.json",
