...
6. Read the active [Phase 013](docs/013-concept-mapping-interaction-semantics-user-visible-representation/) record.
7. Treat older `docs/canonical/experience/` contracts as admitted evidence/candidates unless their assigned Phase-013 workstream has explicitly accepted/reworked them.
8. Use current synchronization owners for interaction/composition rules; mapping does not replace composition.
