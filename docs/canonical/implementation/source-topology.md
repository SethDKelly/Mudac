...
<a id="src-001"></a>
## SRC-001 — Source topology realizes semantic ownership without mirroring the knowledge tree
...
<a id="src-002"></a>
## SRC-002 — Deployable apps are composition roots, not semantic owners
...
<a id="src-003"></a>
## SRC-003 — Each authoritative server module is a separate workspace package
...
<a id="src-004"></a>
## SRC-004 — Module public exports are explicit and private implementation is not cross-importable
...
<a id="src-005"></a>
## SRC-005 — Cross-module dependencies follow an explicit acyclic allowlist and use public contracts
...
<a id="src-006"></a>
## SRC-006 — Cross-module application coordination lives above module owners
...
<a id="src-007"></a>
## SRC-007 — Cross-module projections are isolated and non-authoritative
...
<a id="src-008"></a>
## SRC-008 — Shared foundation remains small, business-neutral, and runtime-neutral
...
<a id="src-009"></a>
## SRC-009 — Infrastructure adapters stay owner-local and depend inward
...
<a id="src-010"></a>
## SRC-010 — Browser source cannot import server semantic or persistence implementation
...
<a id="src-011"></a>
## SRC-011 — Front-end layers have enforceable inward dependency direction
...
<a id="src-012"></a>
## SRC-012 — Generated transport artifacts are isolated, reproducible consumers of API contracts
...
<a id="src-013"></a>
## SRC-013 — Test/source boundaries preserve production ownership
...
<a id="src-014"></a>
## SRC-014 — Workspace dependencies are explicit and cannot bypass package exports
...
<a id="src-015"></a>
## SRC-015 — Package exports and dependency-cruiser enforce the source graph
...
<a id="src-016"></a>
## SRC-016 — Circular production dependencies and boundary violations are blocking defects
