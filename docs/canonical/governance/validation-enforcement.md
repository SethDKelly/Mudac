...
- runs deterministic context-budget measurement for startup/routing surfaces and representative task packs;
- validates portable canonical skills, thin Cursor/Claude adapters, Codex no-duplicate configuration, and evidence-calibrated tool compatibility;
